...
class Sisia(unittest.TestCase):
    ...
    def test01_registro(self):
        ...
        for r in range(ren, rows + 1):
            ...
            if tbl3 == "Existe":
                tbl3 = f.localizar_elemento("cantidadTable__animales__1")
                tbl3 = f.obtenerTexto_id("cantidadTable__animales__1")
            ...
            if tbl5 == "Existe":
                ...
                for r in range(1, nf):
                    ...
                    for ch in range(0, 15):
                        ...
                        f.combo_index("(//select[contains(@id,'raza')])[" + str(ch+1) + "]", str(raz))
                        f.combo_index("(//select[contains(@id,'id_vacuna')])["+str(ch+2)+"]", str(vacc))
