...
#
#pytest -v -s --html=report_t5.html --self-contained-html adefoc_t5.py
...
class Sisia(unittest.TestCase):
    ...
    def test01_registro(self):
        ...
        for r in range(ren, rows + 1):
            ...
            tbl5 = f.existe_try_class_name("tablaDTuberculosis")
            Iden = f.localizar_elemento_css("tablaDTuberculosis")
            f.tiempo(2)
            ...
            if tbl5 == "Existe":
                ...
                print("Tabla tablaDTuberculosis: " + str(tb5_entero))
                ...
                for rt in range(1, nf):
                    ...
                    for ch in range(0, 15):
                        ...
                        f.combo_index("//select[contains(@id,'id_resultado_tablaDTuberculosis__"+str(ch)+"')]", str(vacc))
